  ...
  return (
    <div className={`management-page${presentationMode ? " management-page-presenting" : ""}`} style={presentationStyle}>
      ...
      {error ? (
        ...
        <>
          {area === "empresa" ? <CompanyView cashSnapshot={latestCompanyCashSnapshot(areaValues, months.find((month) => month.isCurrent)!.key)} metricValue={metricValue} metricValueForMonth={metricValueForMonth} metricHelper={metricHelper} seriesFor={seriesFor} months={months} revenueBreakdown={latestBreakdown("receita_plano_contas")} expenseBreakdown={latestBreakdown("despesa_plano_contas")} /> : null}
  ...
  return (
    <div className="management-view-stack">
      ...
      <section className="management-panel">
        <div className="management-panel-head"><div><span>Pós-vendas e jurídico</span><h2>Tração das unidades quitadas</h2><p>Sem processo e Autorizadas com Último Recebimento até o último dia de cada mês, de janeiro até o fechamento de {closedMonth.label}.</p></div></div>
